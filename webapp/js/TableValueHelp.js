sap.ui.define([ 
	...
	return {        
        ...
        handleFormValueHelp: async function (oEvent, oThis) {
            ...
            if (!me._tableValueHelpDialog) {
                me._tableValueHelpDialog = sap.ui.xmlfragment(
                    "zuimrp.view.fragments.valuehelp.TableValueHelpDialog",
                    me
                );
        ...
        handleTableValueHelp: async function (oEvent) {
            ...
            await this._tableValueHelp.getResources(oSource, this);
            ...
            var aColumns = [], oDDTextParam = [];
            var oDDText = this.getView().getModel("caption").getData();
        ...
        getResources: async function(pSource, pThis) {
            var oSource = pSource;
            var oModel = pThis.getOwnerComponent().getModel();
            var sModel = pThis._inputSource.getParent().getParent().mBindingInfos.rows.model;
            var sEntity = "";
            var promiseResult;
            ...
            if (pThis._inputField == "MATTYP") {
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "mattyp");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
                            resolve();
                        }
                    })
                });
            }
            else if (pThis._inputField == "GMCNRKEYCD") {
                var sPath = oSource.getParent().oBindingContexts[sModel].sPath;
                sEntity = "/GMCRangeRscSet";
                var sFilter = "";
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "gmcnrkeycd");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
            ...
            else if (pThis._inputField == "PROCESSCD") {
                var sPath = oSource.getParent().oBindingContexts[sModel].sPath;
                sEntity = "/ProcessRscSet";
                var sFilter = "";
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "processcd");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
            ...
            else if (pThis._inputField == "EXCMATTYP") {
                var sPath = oSource.getParent().oBindingContexts[sModel].sPath;
                sEntity = "/ExcessMatTypeRscSet";
                var sFilter = "";
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "excmattyp");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
            ...
            else if (pThis._inputField == "USGCLS") {
                var sPath = oSource.getParent().oBindingContexts[sModel].sPath;
                sEntity = "/UVRscSet";
                var sFilter = "";
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "usgcls");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
            ...
            else if (pThis._inputField == "BOMATRB") {
                var sPath = oSource.getParent().oBindingContexts[sModel].sPath;
                sEntity = "/BOMAttribRscSet";
                var sFilter = "";
                ...
                promiseResult = new Promise((resolve, reject) => {
                    oModel.read(sEntity, {
                        ...
                        success: function (data, response) {
                            console.log("onValueHelpRequest", data)
                            pThis.getView().setModel(new JSONModel(data.results), "bomatrb");
                            resolve();
                        },
                        error: function (err) { 
                            pThis.closeLoadingDialog();
